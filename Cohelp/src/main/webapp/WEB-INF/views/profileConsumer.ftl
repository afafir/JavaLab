            ...
            <div class="tab-content profile-tab" id="myTabContent">
                            ...
                            <div class="row">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="/task?id=${task.id}" class="btn btn-primary">К заданию</a>
                                    </div>
                                </div>
                            </div>
                        </#if>
                ...
                <div class="tab-pane fade" id="request" role="tabpanel" aria-labelledby="request-tab">
                    <form action="/profile/create" method="post">
                        ...
                        <div class="form-group row">
                            <label for="role" class="col-md-4 col-form-label text-md-right">Что вы хотите?</label>
                            <div class="col-md-6">
                        ...
                        <input type="hidden" id="consumer" name="consumer" value="${user.id}">
