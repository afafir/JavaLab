                            ...
                            <div class="card-body">
                                <form action="signUp" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="city" value="г Казань" name="city" type="text" disabled="true" class="form-control" required />                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="tel" id="tel" class="form-control" name="tel" pattern="\+7\-[0-9]{3}\-[0-9]{3}\-[0-9]{2}\-[0-9]{2}" required >
                                        </div>
                                    </div>
